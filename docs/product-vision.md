...
This document is the North Star for Fortuna. It explains what the product is for, who it serves, and where it's going. It's intentionally high level. Feature specs and technical designs live in [`.specs/`](../.specs/) and [`docs/architecture/decisions/`](./architecture/decisions/).
