...
const externalLinks = [
  { label: "View on GitHub", href: "https://github.com/emiliosheinz/fortuna" },
  { label: "Documentation", href: "https://github.com/emiliosheinz/fortuna" },
  {
    label: "Roadmap",
  ...
  {
    label: "Changelog",
    href: "https://github.com/emiliosheinz/fortuna/releases",
  },
  { label: "Wiki", href: "https://github.com/emiliosheinz/fortuna/wiki" },
  {
    label: "Contribute on GitHub",
    href: "https://github.com/emiliosheinz/fortuna?tab=contributing-ov-file#contributing-to-fortuna",
  },
];
...
test.describe("Home Page", () => {
  test("loads and renders key sections", async ({ page }) => {
    ...
    await test.step("renders header and hero", async () => {
      ...
      await expect(
        page.getByRole("heading", { name: "Take control of your finances" }),
      ).toBeVisible();
    });
  ...
  test.describe("External navigation", () => {
    ...
    test("has correct href for footer GitHub icon link", async ({ page }) => {
      ...
      await expect(footerGitHubLink.first()).toHaveAttribute(
        "href",
        "https://github.com/emiliosheinz/fortuna",
      );
    });
  });
});
