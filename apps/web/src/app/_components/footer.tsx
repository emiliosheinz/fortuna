      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div className="col-span-1 max-w-sm">
            ...
            >
              ...
              />
              <span className="text-xl">Fortuna</span>
            </a>
            <p className="mt-3 text-muted-foreground">
              Your financial companion for instant tracking and smart insights.
              Open source, built in public, and designed for the way you spend.
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-8 border-border gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              aria-label="GitHub"
              href="https://github.com/emiliosheinz/fortuna"
              className="text-muted-foreground hover:text-foreground transition-colors"
            >
