...
const openSource = [
  ...
  },
  {
    ...
    description:
      "Every feature is exposed through public APIs. Build integrations, extensions, and tools on top of Fortuna.",
  },
  {
    icon: Users,
    title: "Community-Driven",
    description:
      "Join developers and finance-minded people shaping the future of personal finance management.",
  },
  {
    icon: Puzzle,
    title: "Extensible by Design",
    description:
      "Integrate with Raycast, MCP servers, browser extensions, and more. Fortuna meets you where you work.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed text-center lg:text-left">
                Fortuna is completely transparent from day one. We believe the
                best tools are built with the community, not behind closed
                doors.
              </p>
                ...
                <div className="font-mono text-sm">
                  ...
                  <pre className="text-xs leading-relaxed">
                    <code className="text-muted-foreground">
                      ...
                      <span className="text-green-400">'@fortuna/sdk'</span>
                      {"\n\n"}
                      <span className="text-blue-400">const</span> client ={" "}
                      <span className="text-yellow-400">fortuna</span>({"{"}
                      {"\n  "}apiKey: process.env.
                      <span className="text-cyan-400">FORTUNA_API_KEY</span>
                      {"\n}"}){"\n\n"}
                      <span className="text-gray-500">
                        {/** biome-ignore lint/suspicious/noCommentText: comments in the codeblock */}
                        // Track an expense instantly
                      </span>
                      {"\n"}
                      <span className="text-purple-400">await</span> client.
                      <span className="text-yellow-400">track</span>({"{"}
                      {"\n  "}amount:{" "}
                      <span className="text-green-400">42.50</span>,{"\n  "}
                      category: <span className="text-green-400">"food"</span>
                      {"\n}"}){"\n\n"}
                      <span className="text-gray-500">
                        {/** biome-ignore lint/suspicious/noCommentText: comments in the codeblock */}
                      ...
                      {"\n"}
                      <span className="text-blue-400">const</span> insights ={" "}
                      <span className="text-purple-400">await</span> client.
                      <span className="text-yellow-400">insights</span>({"{"}
                      {"\n  "}period:{" "}
                      <span className="text-green-400">"last 30 days"</span>
                      {"\n}"})
                    </code>
                  </pre>
                </div>
